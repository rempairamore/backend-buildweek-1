        ...
        <section class="articoli d-flex row justify-content-evenly">
            ...
            if ($custom_query->have_posts()) {
                ...
                while ($custom_query->have_posts()) {
                    ...
                    <article class="single-article-home d-flex flex-column align-items-center align-items-lg-center col-12 col-lg-6 col-xxl-4 p-3 <?php ($count == 3) ? print("d-lg-none d-xxl-block") : "" ?>">
